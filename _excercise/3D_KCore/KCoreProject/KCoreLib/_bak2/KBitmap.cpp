#include "KBitmap.h"
bool KBitmap::Load(TCHAR* pszLoadFile)
{
...
bool KBitmap::Load(DWORD bitmap)
{
...
void		KBitmap::Set(HDC hdc)
{
	m_hScreenDC = hdc;
};
bool		KBitmap::Draw(HDC hDC, 
	tPOINT pos, 
	RECT rt,
	DWORD dwScale,
	DWORD opMode,
...
bool KBitmap::SaveFile(HBITMAP hBitmap, TCHAR* strSaveFile)
{
	BITMAP bitmap;
