...
LRESULT KWindow::MsgProc(HWND hWnd,
	UINT msg,
	WPARAM wParam,
	LPARAM lParam)
{
...
void KWindow::CenterWindow()
{
	...
	//AdjusKWindowRectEx(&rt, 
	//	GeKWindowStyle(m_hWnd), 
	//	GetMenu(m_hWnd) != NULL, 
	//	GeKWindowExStyle(m_hWnd));
...
bool	KWindow::ResizeClient(UINT iWidth, UINT iHeight)
{
