...
#define KCore_START int WINAPI wWinMain(HINSTANCE hInstance,HINSTANCE hPrevInstance,LPWSTR    lpCmdLine,int       nCmdShow){CMain main;
#define KCore_WIN(s,x,y) if (main.SetWindow(hInstance, L#s, x, y))	{	main.Run();	} }
#define KCore_RUN(s,x,y) KCore_START;KCore_WIN(s,x,y);
#define KCore_END }
...
#define DEBUGMSG(lpText)
	...
	extern float		g_fSecondPerFrame; // 1프레임의 경과시간
