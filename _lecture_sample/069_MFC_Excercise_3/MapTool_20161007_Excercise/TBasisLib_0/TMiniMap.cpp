...
bool TMiniMap::Create(ID3D11Device* pd3dDevice, TCHAR* pLoadShaderFile, TCHAR* pLoadTexture)
{
...
bool TMiniMap::BeginRender(ID3D11DeviceContext*    pContext, D3DXVECTOR4 vColor )
{
