...
void TSelect::SetMatrix(D3DXMATRIX* pWorld, D3DXMATRIX* pView, D3DXMATRIX* pProj)
{
	if (pWorld != NULL)
	{
		m_matWorld = *pWorld;
...
D3DXVECTOR3 TSelect::GetIntersection()
{
...
bool TSelect::ChkPick(D3DXVECTOR3& v0, D3DXVECTOR3& v1, D3DXVECTOR3& v2)
{
	FLOAT fBary1, fBary2;
	FLOAT fDist;
...
bool TSelect::IntersectTriangle(const D3DXVECTOR3& orig, const D3DXVECTOR3& dir,
