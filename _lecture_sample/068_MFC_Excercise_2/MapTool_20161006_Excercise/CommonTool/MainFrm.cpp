...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	// 추가함_S
	if (TRUE == m_wndMapCtrl.CreateEx(NULL, _T("map"), 
	...
	// 추가함_S
	if (TRUE == m_wndEffectCtrl.CreateEx(NULL, _T("effect"),
		this, CRect(0, 0, 300, 300),
		TRUE, 5678,
		WS_CHILD | WS_VISIBLE | CBRS_LEFT | WS_CLIPSIBLINGS
		| WS_CLIPCHILDREN | CBRS_FLOAT_MULTI)) {
	...
	if (TRUE == m_wndTabPane.Create(NULL, this,
		...
		| WS_CLIPCHILDREN | CBRS_FLOAT_MULTI)) 
	{
		m_wndTabPane.AddTab(&m_wndEffectCtrl);
		m_wndTabPane.AddTab(&m_wndMapCtrl);
