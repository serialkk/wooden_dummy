...
D3DXMATRIX TAnimation::Interpolate(TMesh* pMesh, D3DXMATRIX* matParents, float fFrameTick, TScene tScene)
{
...
D3DXMATRIX TAnimation::Update(float fElapseTime, TMesh* pMesh, D3DXMATRIX &matParent, TScene &tScene)
{
