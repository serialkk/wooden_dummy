...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_COMMAND(ID_MAPLOAD, &CMainFrame::OnMapload)
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	lstBasicCommands.AddTail(ID_CREATEMAP);
	lstBasicCommands.AddTail(ID_MAPLOAD);
	lstBasicCommands.AddTail(ID_MAPSAVE);
...
void CMainFrame::OnMapload()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
}


void CMainFrame::On32797()
{
	static TCharView dlg;
