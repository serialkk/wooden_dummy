...
T_POSITION TBspTree::ClassifyPoint( TPolygon* pPlane, D3DXVECTOR3* pPos )
{
...
bool TBspTree::GetIntersection( D3DXVECTOR3& vStart, D3DXVECTOR3& vEnd , 
...
void TBspTree::SetMatrix( D3DXMATRIX* pWorld, D3DXMATRIX* pView, D3DXMATRIX* pProj )
{
